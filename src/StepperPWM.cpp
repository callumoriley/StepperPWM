 ...
 */
StepperPWM::StepperPWM(int number_of_steps, int motor_pin_1, int motor_pin_2, int duty_cycle)
{
 ...
 *   Sets which wires should control the motor.
 */
StepperPWM::StepperPWM(int number_of_steps, int motor_pin_1, int motor_pin_2,
 ...
 */
void StepperPWM::setSpeed(long whatSpeed)
{
 ...
 */
void StepperPWM::step(int steps_to_move)
{
 ...
 */
void StepperPWM::stepMotor(int thisStep)
{
  if (this->pin_count == 2) {
    switch (thisStep) {
      case 0:  // 01
        digitalWrite(motor_pin_1, LOW);
        analogWrite(motor_pin_2, this->duty_cycle);
      break;
      case 1:  // 11
        analogWrite(motor_pin_1, this->duty_cycle);
        analogWrite(motor_pin_2, this->duty_cycle);
      break;
      case 2:  // 10
        analogWrite(motor_pin_1, this->duty_cycle);
  ...
  if (this->pin_count == 4) {
    switch (thisStep) {
      case 0:  // 1010
        analogWrite(motor_pin_1, this->duty_cycle);
        digitalWrite(motor_pin_2, LOW);
        analogWrite(motor_pin_3, this->duty_cycle);
      ...
      case 2:  //0101
        ...
        analogWrite(motor_pin_4, this->duty_cycle);
      break;
      case 3:  //1001
        analogWrite(motor_pin_1, this->duty_cycle);
        digitalWrite(motor_pin_2, LOW);
  ...
  if (this->pin_count == 5) {
    switch (thisStep) {
      case 0:  // 01101
        ...
        analogWrite(motor_pin_3, this->duty_cycle);
        digitalWrite(motor_pin_4, LOW);
        analogWrite(motor_pin_5, this->duty_cycle);
        break;
      case 1:  // 01001
        digitalWrite(motor_pin_1, LOW);
        analogWrite(motor_pin_2, this->duty_cycle);
